...
<section>
    ...
    <div id="reset-password-form" class="form-container">
        <form action="" method="post">
            ...
            <button type="submit" name="reset-password-form">Changer le mot de passe</button>
        </form>
    </div>
</section>
...
<section>
    ...
    <div class="form-container">
        <form action="" method="post">
            ...
            <button type="submit" name="firm-form">Ajouter l'établissement</button>
        </form>
    </div>

...
//     //Recipients
    ...
    $mail->addAddress($mailTo, 'double L');     // Add a recipient
    // $mail->addReplyTo('noobdoggydogg@gmail.com', 'Information');
...
sendMail("loic.lagardere@free.fr", "test email", "bodyyyyyyyyyyyyyyyyyy");
                                    ...
                                    <td width="400" align="center">
                                        <div class="contentEditableContainer contentTextEditable">
                                            <div class="contentEditable" align="left" >
                                                  <p >Votre pseudo, [Psueudo],</p> <!-- Username -->
                                                      <br/>
                                                      <br/>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="200" height="50">
                                            <tr>
                                                <td bgcolor="#58b1bd" align="center" style="border-radius:4px;" width="200" height="50">
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align="center" >
                                                              <a target="_blank" href="#" class="link2">Mon compte</a> <!-- link to confirm -->
                                                        </div>
                                                      </div>
                                                </td>
                                            </tr>
